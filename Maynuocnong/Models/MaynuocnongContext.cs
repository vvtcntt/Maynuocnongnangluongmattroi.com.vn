...
using Maynuocnong.Models.Mapping;

namespace Maynuocnong.Models
{
    public partial class MaynuocnongContext : DbContext
    {
        static MaynuocnongContext()
        {
            Database.SetInitializer<MaynuocnongContext>(null);
        }

        public MaynuocnongContext()
            : base("Name=MaynuocnongContext")
        {
        }

        public DbSet<tblAgency> tblAgencies { get; set; }
        public DbSet<tblBank> tblBanks { get; set; }
        public DbSet<tblBBO> tblBBOes { get; set; }
        public DbSet<tblCapacity> tblCapacities { get; set; }
        public DbSet<tblCapacityToGroupProduct> tblCapacityToGroupProducts { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new tblBBOMap());
            modelBuilder.Configurations.Add(new tblCapacityMap());
            modelBuilder.Configurations.Add(new tblCapacityToGroupProductMap());
